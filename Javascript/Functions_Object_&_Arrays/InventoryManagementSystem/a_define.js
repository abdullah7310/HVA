...
function displayProducts() {
    inventory.forEach(invent => {
        console.log(`${invent.name} - ${invent.price}(${invent.quantity})`);
...
addProduct(6, "kurta", 350, 20, "Life Styling")
...
console.log(updateProduct(60, 5000))
...
updateProductWithMap(3,3123456000)
console.log("updated inventory after using map" ,inventory);
...
removeProduct(2)
console.log('removed inventory',inventory);
